...
---
main 함수의 조건문에서는 size가 0 초과 256 미만이라고 정해줬다. 따라서 size에 0을 입력했을 경우 아래의 read 함수에서 size - 1이 되면서 read 함수의 3번째 인자가 unsigned int형이기 때문에 Integer Overflow가 발생한다. 따라서 buf의 사이즈보다 더 많은 값을 넣어줄 수 있으며 BOF 취약점이 발생한다.<br>

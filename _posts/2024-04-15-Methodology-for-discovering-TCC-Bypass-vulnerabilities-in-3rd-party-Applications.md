...
> 본 게시글은 **Responsible Vulnerability Disclosure** 모델에 의해 공개되었으며, 게시글에 언급된 모든 취약점들은 제보 조치 이후 90일이 지난 취약점임을 알려드립니다.<br>
...
| Epic Games Launcher.app
 | Hackerone   | Epic Games | 거절 - Duplicated        | Unknown        | Allow Env Variables                          | N/A                                                                                |
| Logi Options Plus.app    | Hackerone
  | Logitech   | 거절 - Duplicated        | Unknown        | Allow Env Variables                          | N/A                                                                                |

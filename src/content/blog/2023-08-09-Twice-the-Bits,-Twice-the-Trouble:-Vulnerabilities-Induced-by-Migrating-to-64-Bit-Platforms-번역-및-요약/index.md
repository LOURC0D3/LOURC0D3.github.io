...
*Figure 1: Integer truncation → buffer overflow*
...
*Figure 2: Integer overflow → buffer overflow*
...
*Figure 3: Sign-extension → buffer overflow*
...
*Figure 6: A check to avoid buffer overflows on 32-bit
systems that is ineffective on LP64 platforms*
...
*Figure 7: Buffer overflow resulting from an integer
overflow due to larger strings on 64-bit platforms*
...
- 64bit 플랫폼에서는 문자열의 길이가 INT_MAX 보다 클 수 있으므로 반환되는 데이터가 snprintf의 반환 자료형인 int를 초과할 수 있다.
    - 해당 경우에 대해 C99 표준은 -1을 반환하도록 정의하였다.
        ...
        *예 : glibc-2.29/stdio-common/vfprintf-internal.c:1242 - vfprintf*
...
*Figure 9: Stack-corruption vulnerability on 64-bit systems due to unexpected behavior of snprintf*
